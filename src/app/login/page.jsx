        ...
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-xl border border-gray-100">
          <div className="card-body">
            ...
            <p className="mt-4 text-sm text-center text-gray-600">
              ...
              <Link href="/register" className="text-primary underline font-medium hover:opacity-80">
                Register
              </Link>
            </p>
          </div>
...
function mapFirebaseError(code) {
  switch (code) {
    ...
    case "auth/popup-blocked":
      return "Your browser blocked the popup. Please allow popups.";
